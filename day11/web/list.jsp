        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${requestScope.userByPage.currentPage-1}&rows=5
                        &name=${requestScope.conditions.name[0]}&address=${requestScope.conditions.address[0]}&email=${requestScope.conditions.email[0]}" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <c:forEach begin="1" end="${requestScope.userByPage.totalPage}" var="i">
                    <c:if test="${requestScope.userByPage.currentPage == i}">
                        <li class ="active"><a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${i}&rows=5
                        &name=${requestScope.conditions.name[0]}&address=${requestScope.conditions.address[0]}&email=${requestScope.conditions.email[0]}">${i}</a></li>
                    </c:if>
