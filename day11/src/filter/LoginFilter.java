...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws ServletException, IOException {
        ...
        //登录的过滤掉
        if(uri.contains("/login.jsp") || uri.contains("/loginServlet") || uri.contains("/regsiterServlet") ||
                uri.contains("/js/") || uri.contains("/css/") || uri.contains("/fonts/") || uri.contains("/checkCode")){ //放行
